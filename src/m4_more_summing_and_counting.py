...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 0
    answer = count_cosines_from(3, 5, 0.83)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(2, 4, -0.89)
    ...
    # Test 6:
    expected = 0
    answer = count_cosines_from(15, 17, 0.09)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.833333333333  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 3)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.616666666666  # This is APPROXIMATELY the correct answer.
